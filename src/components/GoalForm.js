...
function GoalForm({ onGeneratePlan, isLoading }) {
    ...
    return (
        <div className="min-h-screen bg-neutral-950 flex flex-col justify-center items-center p-4">
            ...
            <div className="bg-black text-purdue-gold p-8 rounded-xl shadow-lg w-full max-w-4xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        <div className="mb-6">
                            ...
                            <button className="py-2 px-4 border border-gray-300 rounded-md text-sm text-purdue-gold hover:bg-gray-50">Vegetarian</button>
                            <button className="py-2 px-4 border border-gray-300 rounded-md text-sm text-purdue-gold hover:bg-gray-50">Vegan</button>
                            <button className="py-2 px-4 border border-gray-300 rounded-md text-sm text-purdue-gold hover:bg-gray-50">Gluten-Free</button>
                            <button className="py-2 px-4 border border-gray-300 rounded-md text-sm text-purdue-gold hover:bg-gray-50">Dairy-Free</button>
                            <button className="py-2 px-4 border border-gray-300 rounded-md text-sm text-purdue-gold hover:bg-gray-50">Nut-Free</button>
                            <button className="py-2 px-4 border border-gray-300 rounded-md text-sm text-purdue-gold hover:bg-gray-50">Shellfish-Free</button>
                        </div>
                    </div>
