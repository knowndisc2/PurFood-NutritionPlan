...
const firebaseConfig = {
  ...
  storageBucket: "general-nutrition-manager.firebasestorage.app",
...
export { db, auth, provider, signInWithPopup, signInWithEmailAndPassword, createUserWithEmailAndPassword };
